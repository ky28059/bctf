...
export default async function Header() {
    ...
    return (
        <header className="relative container flex flex-col items-center justify-center h-screen">
            {/*
            <img
            ...
            */}
            ...
            <h1
                className="flex gap-2 text-8xl font-bold text-white/50 bg-clip-text mb-4 mt-16 drop-shadow-md"
                style={hubot.style}
            >
                b01lers CTF
            ...
            <p className="mb-2.5 max-w-3xl text-center text-pretty">
