...
function ChallengeTab(props: { value: string, children: ReactNode }) {
    return (
        <Tabs.Trigger
            className="rounded-t border-b text-primary aria-selected:border-t aria-selected:border-x aria-selected:border-b-transparent aria-selected:text-white transition-[color] duration-200 border-secondary px-4 py-2 focus:outline-none"
            value={props.value}
        >
            {props.children}
        </Tabs.Trigger>
