...
export default function SolvesModal(props: SolvesModalProps) {
    return (
        <CenteredModal
            className="bg-background rounded-lg px-8 py-6 text-white shadow-lg w-full max-w-xl max-h-[90%]"
            open={props.open}
            setOpen={props.setOpen}
        >
            <Dialog.Title className="flex gap-2 items-center text-2xl font-bold mb-4 wrap-anywhere">
